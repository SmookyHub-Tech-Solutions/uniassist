...
<table class="data-table w-full text-sm"><thead class="bg-slate-50 text-slate-500 text-left"><tr><th class="p-3 font-semibold">Ticket</th><th class="p-3 font-semibold">Student</th><th class="p-3 font-semibold">Subject</th><th class="p-3 font-semibold">Assigned</th><th class="p-3 font-semibold">Status</th><th class="p-3 font-semibold">Created</th></tr></thead><tbody>
<?php foreach ($rows as $t): ?>
  <tr class="border-t border-slate-100 hover:bg-slate-50">
    <td class="p-3"><a class="text-brand font-medium" href="<?= url('support/ticket.php?id=' . $t['id']) ?>"><?= e($t['ticket_number']) ?></a></td>
...
<?php endforeach; if (!$rows): ?><tr><td colspan="6" class="p-6 text-center text-slate-500">No tickets found.</td></tr><?php endif; ?>
</tbody></table></div>
<?php layout_bottom();
